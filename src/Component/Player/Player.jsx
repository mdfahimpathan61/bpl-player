    ...
    return (
        <div className='p-5 rounded-lg shadow-lg m-2'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <button onClick={() => setChooseBtn(!chooseBtn)} disabled={chooseBtn} className={` btn  btn-ghost bg-gray-100 text-black hover:bg-[#E7FE29] border ${chooseBtn?"":"border-[#E7FE29]"} rounded-lg`}>{chooseBtn?"Selected":"Choose Player"}</button>
            </div>
        </div>
    );
};
